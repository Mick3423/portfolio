...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Amatic+SC&family=Roboto:wght@100;300&display=swap" rel="stylesheet">
...
<nav class="navbar navbar-expand-lg ">
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse " id="navbarSupportedContent">
            <ul class="navbar-nav mb-auto align-items-end">

                <li class="nav-item">
                    <a class="nav-link active" href="#skoleopgaver">skole projekter</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link active" href="#fritid">fritidsprojekter</a>
                </li>

                <li class="nav-item">
                    <a class="nav-link active" href="#om">om mig</a>
                </li>
...
<section id="om">
    <div class=" container ">
        <div class="row justify-content-center">
            <div class="card om m-3">
                <div class="row g-0">
                    <div class="col-md-4">
                        <img src="images/michael.png" class="img-fluid rounded-circle start" alt="michael billede">
                    </div>
...
<footer>
    <div class="container-fluid text-dark text-center bg-dark-subtle">

        <p class="display-4 mb-1 text-uppercase">socialmedier</p>
        <a class="btn btn-outline-success btn-floating mb-2" href="https://www.facebook.com/profile.php?id=100000312770132" role="button">
            <i class="fab fa-facebook-f"></i>
        </a>

        <a class="btn btn-outline-success btn-floating mb-2" href="https://www.linkedin.com/in/michael-mørkeberg/" role="button"
        ><i class="fab fa-linkedin-in"></i
            ></a>
        <a class="btn btn-outline-success btn-floating mb-2" href="https://github.com/Mick3423" role="button"
